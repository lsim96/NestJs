...
import { User, UseCredentials } from "../interfaces/user.interface";
...
export class AuthController {
  ...
  static loginUser: RequestHandler = async (req, res) => {
    try {
      ...
      res.set("acess-token", accessToken);
